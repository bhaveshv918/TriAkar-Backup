...
/* ════════════════════════════════════════════════════════════════════
   SMOKY PRELOADER REVEAL — site-wide
   Runs synchronously (partials.js is blocking) so ta-loading is set
   on <html> before first paint, keeping content hidden until ready.
   ════════════════════════════════════════════════════════════════════ */
(function(){
  var html=document.documentElement;
  html.classList.add('ta-loading');

  function inject(){
    if(document.getElementById('ta-preloader'))return;
    var el=document.createElement('div');
    el.id='ta-preloader';
    el.setAttribute('aria-hidden','true');
    el.innerHTML=
      '<div class="ta-pre-brand">'+
        '<div class="ta-pre-wordmark"><em>TRI</em>AKAR</div>'+
        '<span class="ta-pre-hindi">त्रिआकार</span>'+
        '<span class="ta-pre-tagline">Designed globally · Made in India</span>'+
      '</div>'+
      '<div class="ta-pre-dots">'+
        '<div class="ta-pre-dot"></div>'+
        '<div class="ta-pre-dot"></div>'+
        '<div class="ta-pre-dot"></div>'+
      '</div>'+
      '<div class="ta-pre-bar"><div class="ta-pre-bar-fill"></div></div>';
  ...
  function reveal(){
    ...
    setTimeout(function(){
      html.classList.remove('ta-loading');
      html.classList.add('ta-ready');
      var pre=document.getElementById('ta-preloader');
      if(pre){
        pre.classList.add('ta-pre-exit');
