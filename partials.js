...
window._FOOTER_HTML = `<footer>
  <div class="mw">
    ...
    <div class="foot-bottom">
      ...
      <p class="foot-tag" style="font-family:var(--font-g);text-transform:uppercase;letter-spacing:.02em;font-size:13px">Crafting the <span style="color:var(--accent)">Third</span> Dimension</p>
    </div>
