...
INSERT INTO instant_quote_materials (name, filament_type, density_g_cm3, cost_per_gram_public, is_default, sort_order) VALUES
  ('PLA+',      'PLA+',     1.24, 1.70, true,  1),
  ('PLA',       'PLA',      1.24, 1.50, false, 2),
  ('PETG',      'PETG',     1.27, 1.90, false, 3),
  ('TPU',       'TPU',      1.21, 2.80, false, 4),
  ('PLA-CF',    'PLA-CF',   1.30, 3.50, false, 5),
  ('PETG-HF',   'PETG-HF',  1.27, 2.20, false, 6),
  ('PETG-CF',   'PETG-CF',  1.35, 3.80, false, 7),
  ('ABS',       'ABS',      1.04, 1.80, false, 8),
  ('ASA',       'ASA',      1.07, 2.10, false, 9);
...
ALTER TABLE instant_quote_requests ADD COLUMN IF NOT EXISTS nozzle_mm   NUMERIC(3,1) NOT NULL DEFAULT 0.4;
