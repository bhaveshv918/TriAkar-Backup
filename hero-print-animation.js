...
(function () {
  ...
  const CFG = {
    ...
    /* Table-lamp silhouette as a 0..1 width ratio, modelled on a real
       ...
       organic taper), then a shade with straight (not curved) sides. */
    widthRatio(i, total) {
      const t = i / total;
  ...
  function depositLayer() {
    ...
    el.style.boxShadow  = 'inset 0 1px 0 rgba(255,255,255,.12), inset 0 -1px 0 rgba(0,0,0,.1), 0 0 0 1px rgba(0,0,0,.22)';
